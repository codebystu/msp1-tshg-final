...
### Colour Scheme
The starting point for colour scheme choice was the "antiquewhite" colour from the standard named palette. I wnated something off-white, with a hint of summer evening sky, to fit my emotional response to the americana style harmonies the band use in their music, a suitable contrasting colour for text was chosen using [Coolor Contrast Checker](https://coolors.co/contrast-checker/2d4219-faebd7). The black and white photo used for the banner image across all main pages, was taken during the video shoot for the latest single "The Empty drive" in which the band swap various bright colours of t-shirt between them, whilst standing in a line performing the song. With the video also being included, I thought it was a striking contrast to have this splash of colour in the video to set it apart from the rest of the site content. Looking at other music artist websites, I was struck with the simplicity of the colour scheme on the [Taylor Swift](https://taylorswift.com) website. It confirmed my thinking and all images were converted to black and white across the project. It gives a consistent clean look to the site, which ellicits the desired emotional response from users.
...
![Navigation Bar](documents/navbar.png)
![Uppercase active and shadow box](documents/linkshadow.png)
- _Banner Image With Overlay_
    - Featured on all pages except the 404 page, the banner with overlay introduces the user to the band with an eye catching, wide angle, black and white headshot image of the six members. There is an overlay when hovering or first tapping on mobile with a callout to stream or download the new album "Dream of a Ghost", with a highlighted link directing the user straight to the stream page. The overlay message and link can be updated, as exampled on the shows page which has details of the next show and a link to the venue website.
...
![Overlay Link](documents/overlaylink.png)
![Alternative Message](documents/altmessage.png)
- _Big Quotes_
...
![Review Quotes](documents/bigquotes.png)
- _History_
...
![Video Player](documents/watch.png)
...
![Stream](documents/stream.png)
![Font Enlarge on Hover](documents/fontenlarge.png)
...
![Mailing List](documents/mailinglist.png)
- _Gallery_
...
![Contact Form](documents/contactform.png)
...
![Message Received](documents/msgreceived.png)
- _Audio Player_
...
![Audio Player](documents/audio.png)
![Thank You Message](documents/thankyou.png)
- _Custom 404 page_
